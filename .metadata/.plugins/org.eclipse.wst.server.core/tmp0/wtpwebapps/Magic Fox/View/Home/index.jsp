...
<body>
	...
	<div class="nav">
		<ul>
			<li>
				<img src="./Public/Image/study.png" class="nav-./Public/Image">
				<a href="" class="nav-a">study</a>
			</li>
			<li>
				<img src="./Public/Image/work.png" class="nav-./Public/Image">
				<a href="" class="nav-a">work</a>
			</li>
			<li>
				<img src="./Public/Image/life.png" class="nav-./Public/Image">
		...
		<div class="clude">
			...
			<div class="article work">
				...
				<div class="theme volunteer">
					<img src="./Public/Image/volunteer.jpg" >
